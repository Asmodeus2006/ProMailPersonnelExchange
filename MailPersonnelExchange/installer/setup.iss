...
#define IconPath "..\python\ressources\logo_promed.ico"
...
MinVersion=10.0
UninstallDisplayIcon={app}\logo_promed.ico
...
; Application icon
Source: "..\python\ressources\logo_promed.ico"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
; Start Menu
Name: "{group}\{#AppName}"; Filename: "{app}\{#AppExe}"; WorkingDir: "{app}"; IconFilename: "{app}\logo_promed.ico"
Name: "{group}\Désinstaller {#AppName}"; Filename: "{uninstallexe}"
; Desktop (optional, controlled by task above)
Name: "{autodesktop}\{#AppName}"; Filename: "{app}\{#AppExe}"; WorkingDir: "{app}"; IconFilename: "{app}\logo_promed.ico"; Tasks: desktopicon
